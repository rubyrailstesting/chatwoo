...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<activerecord>.freeze, [">= 5.0", "< 7.7"])
  s.add_runtime_dependency(%q<activesupport>.freeze, [">= 5.0", "< 7.7"])
  s.add_development_dependency(%q<appraisal>.freeze, [">= 0"])
  s.add_development_dependency(%q<rails>.freeze, [">= 5.0", "< 7.7"])
